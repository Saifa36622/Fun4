...
#ifndef CUSTOM_INTERFACE__SRV__DETAIL__BASIC__FUNCTIONS_H_
#define CUSTOM_INTERFACE__SRV__DETAIL__BASIC__FUNCTIONS_H_
...
/// Create srv/Basic message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interface__srv__Basic_Request__init().
...
/// Destroy srv/Basic message.
/**
 * It calls
 * custom_interface__srv__Basic_Request__fini()
...
/// Check for srv/Basic message equality.
/**
...
/// Initialize array of srv/Basic messages.
/**
...
/// Finalize array of srv/Basic messages.
/**
 * It calls
 * custom_interface__srv__Basic_Request__fini()
...
/// Create array of srv/Basic messages.
/**
 * It allocates the memory for the array and calls
 * custom_interface__srv__Basic_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Basic messages.
/**
 * It calls
 * custom_interface__srv__Basic_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Basic message array equality.
/**
...
/// Copy an array of srv/Basic messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interface__srv__Basic_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interface
...
/**
 * It calls
 * custom_interface__srv__Basic_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interface
...
/**
 * It allocates the memory for the array and calls
 * custom_interface__srv__Basic_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interface
...
/**
 * It calls
 * custom_interface__srv__Basic_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACE__SRV__DETAIL__BASIC__FUNCTIONS_H_
